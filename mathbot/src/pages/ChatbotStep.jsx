  ...
  const stepsMateri2 = [
    {
      ...
      options: [
        { text: "Rasio adalah perbandingan antara dua jumlah.", response: "Tepat sekali! Rasio adalah cara untuk membandingkan dua jumlah atau lebih.", nextStep: 1, isFinish: false },
        { text: "Saya tidak ingat.", response: "Tidak masalah, mari kita ingat bersama. Rasio adalah perbandingan antara dua jumlah atau lebih.", nextStep: 1, isFinish: false },
      ],
    },
    {
      ...
      options: [
        { text: "Lanjut", response: "Lanjut", nextStep: 2, isFinish: false },
      ],
    },
    {
      ...
      options: [
        { text: "Membagi keduanya dengan 2.", response: "Betul sekali! Jika kita membagi 6 dan 4 dengan 2, kita mendapatkan 3:2. Jadi, rasio 6:4 bisa disederhanakan menjadi 3:2.", nextStep: 3, isFinish: false },
        { text: "Menambah angka pada keduanya.", response: "Bukan, menambah angka justru akan mengubah perbandingan. Coba pikirkan apakah kita bisa membagi kedua angka dengan angka yang sama.", nextStep: 3, isFinish: false },
      ],
    },
    {
      ...
      options: [
        { text: "Rasionya adalah 12:8.", response: "Benar! Rasio 12:8 menunjukkan bahwa ada 12 siswa laki-laki dan 8 siswa perempuan. Kamu bisa menyederhanakan rasio ini menjadi 3:2 dengan membagi kedua angka dengan 4. Apakah kamu melihat bagaimana penyederhanaan ini mempermudah perbandingan?", nextStep: 4, isFinish: false },
        { text: "Rasionya adalah 3:2.", response: "Bagus sekali! Rasio 12:8 bisa disederhanakan menjadi 3:2 dengan membagi kedua angka dengan 4. Ini menunjukkan bahwa meskipun angka berbeda, rasionya tetap sama.", nextStep: 4, isFinish: false },
      ],
    },
    {
      ...
      options: [
        { text: "Rasionya adalah 18:12.", response: "Bagus sekali! Rasio 18:12 bisa disederhanakan menjadi 3:2 dengan membagi kedua angka dengan 6. Ini berarti ada 3 siswa yang suka olahraga untuk setiap 2 siswa yang suka seni.", nextStep: 5, isFinish: false },
        { text: "Rasionya adalah 6:4.", response: "Coba lagi. Rasio 18:12 bisa disederhanakan dengan membagi kedua angka dengan 6, sehingga menjadi 3:2. 6:4 tidak benar karena angka-angka tersebut tidak berkaitan dengan 18:12.", nextStep: 5, isFinish: false },
        { text: "Rasionya adalah 3:2.", response: "Tepat sekali! Rasio 18:12 bisa disederhanakan menjadi 3:2. Ini berarti ada 3 siswa yang suka olahraga untuk setiap 2 siswa yang suka seni.", nextStep: 5, isFinish: false },
        { text: "Rasionya adalah 9:6.", response: "Tidak tepat. Rasio 9:6 memang bisa disederhanakan menjadi 3:2, tetapi ini bukan perbandingan yang benar untuk 18:12. Coba pikirkan bagaimana kita bisa menyederhanakan 18:12.", nextStep: 5, isFinish: false },
      ],
    },
    {
      message: "Sekarang, bagaimana jika kita punya dua rasio: 18:12 dan 3:2. Menurutmu, apakah kedua rasio ini sama atau berbeda?",
      options: [
        { text: "Mereka sama.", response: "Tepat sekali! Meskipun angka-angkanya berbeda, rasio 18:12 bisa disederhanakan menjadi 3:2, jadi mereka sebenarnya sama. Ini menunjukkan bahwa rasio yang sama dapat ditulis dengan angka yang berbeda tetapi tetap mewakili perbandingan yang sama.", nextStep: 6, isFinish: false },
        { text: "Mereka berbeda.", response: "Sebenarnya, mereka sama. Rasio 18:12 bisa disederhanakan menjadi 3:2, sehingga kedua rasio ini memiliki perbandingan yang sama.", nextStep: 6, isFinish: false },
      ],
    },
    {
      ...
      options: [
        { text: "Rasionya sama, yaitu 3:2.", response: "Jawaban yang benar adalah bahwa rasio di kedua kelas sama, yaitu 3:2. Walaupun jumlah siswa berbeda, perbandingan antara laki-laki dan perempuan tetap sama di kedua kelas ini.", nextStep: 7, isFinish: false },
        { text: "Berbeda, karena angka-angkanya berbeda.", response: "Meskipun angka-angkanya berbeda, perbandingan atau rasionya sama. Di kedua kelas, kita bisa menyederhanakan rasionya menjadi 3:2.", nextStep: 7, isFinish: false },
      ],
    },
    {
      ...
      options: [
        { text: "Ya, rasionya sama.", response: "Tepat sekali! Rasio 30:20 di kota pertama bisa disederhanakan menjadi 3:2, sama seperti rasio 15:10 di kota kedua yang juga bisa disederhanakan menjadi 3:2. Ini berarti perbandingan kepemilikan mobil di kedua kota ini sama.", nextStep: 8, isFinish: false },
        { text: "Tidak, rasionya berbeda.", response: "Mari kita coba hitung bersama. Rasio 30:20 bisa disederhanakan menjadi 3:2, dan begitu pula rasio 15:10 di kota kedua. Jadi, kedua rasio ini sama.", nextStep: 8, isFinish: false },
      ],
    },
    {
      ...
      options: [
        { text: "Lanjut", response: "Lanjut", nextStep: 9, isFinish: false },
      ],
    },
    {
      message: "Sebelum kita akhiri, apakah ada sesuatu yang ingin kamu tanyakan?",
      options: [
        { text: "Tidak, saya merasa sudah paham semuanya.", response: "Bagus sekali! Saya senang kamu merasa sudah paham. Sampai jumpa di materi berikutnya di mana kita akan mempelajari tentang hubungan antara rasio dengan persamaan linear.", nextStep: 10, isFinish: true },
        { text: "Bolehkah saya mendapatkan lebih banyak contoh soal untuk latihan?", response: "Tentu, saya akan menyiapkan soal tambahan untuk kamu berlatih. Terus semangat belajar!", nextStep: 10, isFinish: false },
        { text: "Saya masih bingung tentang cara menyederhanakan rasio tertentu.", response: "Tidak masalah, mari kita ulangi bagian yang kamu bingungkan. Kita bisa membahasnya lebih lanjut. Silahkan bertanya kepada gurumu, ya!", nextStep: 10, isFinish: true },
        { text: "Apa hubungan antara rasio dan konsep lain seperti persamaan?", response: "Pertanyaan yang bagus! Kita akan membahas hubungan antara rasio dengan persamaan linear di materi berikutnya. Pastikan kamu mengikuti ya!", nextStep: 10, isFinish: true },
      ],
    },
    {
      ...
      options: [
        { text: "Rasionya adalah 7.5:5.", response: "Benar! Rasio 7.5:5 sudah benar. Ini dapat disederhanakan menjadi 3:2. Artinya, untuk setiap 3 liter jus jeruk, ada 2 liter jus apel.", nextStep: 11, isFinish: false },
        { text: "Rasionya adalah 3:2.", response: "Tepat sekali! Rasio 7.5:5 dapat disederhanakan menjadi 3:2. Ini berarti ada 3 liter jus jeruk untuk setiap 2 liter jus apel.", nextStep: 11, isFinish: false },
        { text: "Rasionya adalah 15:10.", response: "Tidak, 15:10 adalah hasil dari mengalikan rasio 7.5:5 dengan 2, bukan hasil penyederhanaan. Coba hitung ulang untuk mendapatkan rasio yang lebih sederhana.", nextStep: 11, isFinish: false },
        { text: "Rasionya adalah 2:3.", response: "Tidak, rasio 2:3 tidak benar untuk perbandingan ini. Coba lihat kembali rasio 7.5:5 dan cara penyederhanaannya.", nextStep: 11, isFinish: false },
      ],
    },
    {
      ...
      options: [
        { text: "Ini berarti untuk setiap 3 liter jus jeruk, ada 2 liter jus apel.", response: "Tepat sekali! Rasio 3:2 berarti bahwa untuk setiap 3 liter jus jeruk, ada 2 liter jus apel. Ini menggambarkan perbandingan antara kedua jenis jus.", nextStep: 12, isFinish: false },
        { text: "Ini berarti ada 3 liter jus jeruk dan 2 liter jus apel secara keseluruhan.", response: "Tidak benar. Rasio 3:2 bukan jumlah total jus jeruk dan apel, melainkan perbandingan antara keduanya.", nextStep: 12, isFinish: false },
        { text: "Ini berarti ada 5 liter jus jeruk dan 3 liter jus apel.", response: "Salah, rasio 3:2 tidak menunjukkan jumlah spesifik jus jeruk dan apel. Rasio ini menggambarkan perbandingan, bukan totalnya.", nextStep: 12, isFinish: false },
        { text: "Ini berarti rasio jus jeruk dan jus apel sama.", response: "Tidak benar. Rasio 3:2 menunjukkan perbandingan, bukan kesamaan jumlah jus jeruk dan jus apel.", nextStep: 12, isFinish: false },
      ],
    },
    {
      message: "Kamu sudah bekerja dengan sangat baik hari ini! Sekarang kamu tahu bahwa rasio adalah cara untuk membandingkan dua jumlah atau lebih, dan kamu juga tahu bagaimana menyederhanakan rasio.",
...
const latihan = [
  {
    message: "Latihan 1: Di sebuah perpustakaan, terdapat 30 buku fiksi dan 20 buku non-fiksi. Bagaimana cara menyatakan rasio jumlah buku fiksi terhadap jumlah buku non-fiksi?",
    options: [
      { text: "A. 30:20", response: "Benar! Rasio 30:20 adalah cara yang tepat untuk menyatakan jumlah buku fiksi terhadap buku non-fiksi.", nextStep: 1, isFinish: false },
      { text: "B. 40:25", response: "Salah, coba lagi. Rasio yang benar adalah 30:20.", nextStep: 1, isFinish: false },
      { text: "C. 50:30", response: "Salah, coba lagi. Rasio yang benar adalah 30:20.", nextStep: 1, isFinish: false },
      { text: "D. 60:40", response: "Salah, coba lagi. Rasio yang benar adalah 30:20.", nextStep: 1, isFinish: false },
    ],
  },
  {
    message: "Latihan 2: Panjang sebuah papan adalah 35 cm dan lebarnya 14 cm. Sederhanakanlah rasio panjang terhadap lebar.",
    options: [
      { text: "A. 5:2", response: "Salah, coba lagi. Rasio yang benar adalah 7:2.", nextStep: 2, isFinish: false },
      { text: "B. 7:3", response: "Salah, coba lagi. Rasio yang benar adalah 7:2.", nextStep: 2, isFinish: false },
      { text: "C. 2:1", response: "Salah, coba lagi. Rasio yang benar adalah 7:2.", nextStep: 2, isFinish: false },
      { text: "D. 7:2", response: "Benar! Rasio panjang terhadap lebar yang disederhanakan adalah 7:2.", nextStep: 2, isFinish: false },
    ],
  },
  {
    message: "Latihan 3: Rasio 20:15 setara dengan rasio mana di bawah ini?",
    options: [
      { text: "A. 4:3", response: "Benar! Rasio 20:15 dapat disederhanakan menjadi 4:3.", nextStep: 3, isFinish: false },
      { text: "B. 8:6", response: "Salah, coba lagi. Rasio yang benar adalah 4:3.", nextStep: 3, isFinish: false },
      { text: "C. 12:10", response: "Salah, coba lagi. Rasio yang benar adalah 4:3.", nextStep: 3, isFinish: false },
      { text: "D. 5:4", response: "Salah, coba lagi. Rasio yang benar adalah 4:3.", nextStep: 3, isFinish: false },
    ],
  },
  {
    message: "Latihan 4: Seorang petani mencampurkan 12 kg pupuk organik dengan 8 kg pupuk kimia untuk digunakan di ladangnya. Jika petani tersebut ingin membuat campuran pupuk dalam jumlah yang lebih besar tetapi dengan rasio yang sama, berapakah rasio lain yang setara dengan 12 kg pupuk organik dan 8 kg pupuk kimia?",
    options: [
      { text: "A. 6 kg pupuk organik dan 4 kg pupuk kimia", response: "Salah, coba lagi. Rasio yang benar adalah 18 kg pupuk organik dan 12 kg pupuk kimia.", nextStep: 4, isFinish: false },
      { text: "B. 9 kg pupuk organik dan 6 kg pupuk kimia", response: "Salah, coba lagi. Rasio yang benar adalah 18 kg pupuk organik dan 12 kg pupuk kimia.", nextStep: 4, isFinish: false },
      { text: "C. 18 kg pupuk organik dan 12 kg pupuk kimia", response: "Benar! Rasio 12:8 setara dengan rasio 18:12.", nextStep: 4, isFinish: false },
      { text: "D. 15 kg pupuk organik dan 10 kg pupuk kimia", response: "Salah, coba lagi. Rasio yang benar adalah 18 kg pupuk organik dan 12 kg pupuk kimia.", nextStep: 4, isFinish: false },
    ],
  },
  {
    message: "Latihan 5: Jika x : 4 = 8 : 16, berapakah nilai x?",
    options: [
      { text: "A. 2", response: "Benar! x = 2 untuk memenuhi persamaan x:4 = 8:16.", nextStep: 5, isFinish: false },
      { text: "B. 4", response: "Salah, coba lagi. Jawaban yang benar adalah x = 2.", nextStep: 5, isFinish: false },
      { text: "C. 8", response: "Salah, coba lagi. Jawaban yang benar adalah x = 2.", nextStep: 5, isFinish: false },
      { text: "D. 16", response: "Salah, coba lagi. Jawaban yang benar adalah x = 2.", nextStep: 5, isFinish: false },
    ],
  },
  {
    message: "Latihan 6: Diketahui persamaan rasio 6 : x = 18 : 9. Hitunglah nilai x.",
    options: [
      { text: "A. 3", response: "Salah, coba lagi. Jawaban yang benar adalah x = 6.", nextStep: 6, isFinish: false },
      { text: "B. 2", response: "Salah, coba lagi. Jawaban yang benar adalah x = 6.", nextStep: 6, isFinish: false },
      { text: "C. 6", response: "Benar! x = 6 untuk memenuhi persamaan 6:x = 18:9.", nextStep: 6, isFinish: false },
      { text: "D. 4", response: "Salah, coba lagi. Jawaban yang benar adalah x = 6.", nextStep: 6, isFinish: false },
    ],
  },
  {
    message: "Latihan 7: Sebuah instruksi mengatakan bahwa rasio bensin terhadap oli dalam campuran bahan bakar untuk mesin tertentu adalah 5:2. Jika kamu menggunakan 25 liter bensin, berapa liter oli yang harus kamu gunakan?",
    options: [
      { text: "A. 10 liter", response: "Benar! Rasio 5:2 berarti jika Anda menggunakan 25 liter bensin, Anda memerlukan 10 liter oli.", nextStep: 7, isFinish: false },
      { text: "B. 5 liter", response: "Salah, coba lagi. Jawaban yang benar adalah 10 liter oli.", nextStep: 7, isFinish: false },
      { text: "C. 15 liter", response: "Salah, coba lagi. Jawaban yang benar adalah 10 liter oli.", nextStep: 7, isFinish: false },
      { text: "D. 12 liter", response: "Salah, coba lagi. Jawaban yang benar adalah 10 liter oli.", nextStep: 7, isFinish: false },
    ],
  },
  {
    message: "Latihan 8: Misalkan kamu memiliki 9 liter cat merah dan ingin mencampurnya dengan cat putih dalam rasio 3:5. Berapa liter cat putih yang kamu butuhkan?",
    options: [
      { text: "A. 10 liter", response: "Salah, coba lagi. Jawaban yang benar adalah 15 liter cat putih.", nextStep: 8, isFinish: false },
      { text: "B. 12 liter", response: "Salah, coba lagi. Jawaban yang benar adalah 15 liter cat putih.", nextStep: 8, isFinish: false },
      { text: "C. 15 liter", response: "Benar! Dengan 9 liter cat merah, Anda memerlukan 15 liter cat putih untuk menjaga rasio 3:5.", nextStep: 8, isFinish: false },
      { text: "D. 6 liter", response: "Salah, coba lagi. Jawaban yang benar adalah 15 liter cat putih.", nextStep: 8, isFinish: false },
    ],
  },
  {
    message: "Latihan 9: Dalam sebuah survei di sekolah, 120 dari 200 siswa mengatakan bahwa mereka lebih suka belajar online daripada tatap muka. Berapakah rasio siswa yang lebih suka belajar online terhadap siswa yang lebih suka belajar tatap muka?",
    options: [
      { text: "A. 3:2", response: "Benar! Rasio 120:80 dapat disederhanakan menjadi 3:2.", nextStep: 9, isFinish: false },
      { text: "B. 3:5", response: "Salah, coba lagi. Jawaban yang benar adalah 3:2.", nextStep: 9, isFinish: false },
      { text: "C. 2:3", response: "Salah, coba lagi. Jawaban yang benar adalah 3:2.", nextStep: 9, isFinish: false },
      { text: "D. 5:3", response: "Salah, coba lagi. Jawaban yang benar adalah 3:2.", nextStep: 9, isFinish: false },
    ],
  },
  {
    message: "Latihan 10: Dari 500 orang yang disurvei, 150 mengatakan bahwa mereka membaca buku setiap hari. Berapakah rasio antara jumlah orang yang membaca buku setiap hari terhadap mereka yang tidak membaca setiap hari?",
    options: [
      { text: "A. 1:4", response: "Salah, coba lagi. Jawaban yang benar adalah 3:7.", nextStep: 10, isFinish: false },
      { text: "B. 3:7", response: "Benar! Rasio 150:350 dapat disederhanakan menjadi 3:7.", nextStep: 10, isFinish: false },
      { text: "C. 2:3", response: "Salah, coba lagi. Jawaban yang benar adalah 3:7.", nextStep: 10, isFinish: false },
      { text: "D. 1:2", response: "Salah, coba lagi. Jawaban yang benar adalah 3:7.", nextStep: 10, isFinish: false },
    ],
  },
];
 
export default {stepsMateri1, stepsMateri2, stepsMateri3, latihan};